...
def run_test_factorial():
    ...
    # -------------------------------------------------------------------------
    # Test 3:
    answer_from_oracle = math.factorial(56)
    answer_from_my_code = factorial(56)
    print('Test 1 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 3
    answer = count_cosines_from(1, 9, 0.5)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    ...
    # Test 4:
    expected = 31
    answer = count_cosines_from(13, 62, -0.31)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(10, 14, 0.7)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 6
    answer = count_cosines_from(7, 36, 0.82)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_sum_unit_fractions_from():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    expected = 2.047739  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 19)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.724559  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(7, 36)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
